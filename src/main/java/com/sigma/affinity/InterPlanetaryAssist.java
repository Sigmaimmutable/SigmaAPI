...
public class InterPlanetaryAssist {
	private static final Logger LOGGER = LoggerFactory.getLogger("com.sigma.affinity.InterPlanetaryAssist");
	/*
...
public JSONObject getAndPersistIPFSFile(JdbcTemplate jdbcTemplate, String docId, String fileName, String sessionId, 
...
public JSONObject getAndPersistIPFSFilePrivate(JdbcTemplate jdbcTemplate, String docId, String fileName, String sessionId, 
